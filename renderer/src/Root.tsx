...
import { BenchmarkGPT6LunaPreview } from './benchmarks/BenchmarkPreviews';
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      <Composition id="Benchmark-GPT-6-Luna" component={BenchmarkGPT6LunaPreview} durationInFrames={180} fps={30} width={1920} height={1080}/>
    </>
  );
};
