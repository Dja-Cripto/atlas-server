...
export const SceneBackdrop:FC<{scene:Scene;backgroundScene?:Scene|null;duration:number}>=({scene,backgroundScene,duration})=>{
  ...
  >
   <AbsoluteFill
     style={{
       ...
       backgroundImage:
         "radial-gradient(circle at 25% 35%,rgba(255,255,255,.2) 0 1px,transparent 2px), radial-gradient(circle at 72% 66%,rgba(255,255,255,.12) 0 1px,transparent 2px)",
 ...
 const style={width:'100%',height:'100%',objectFit:'cover' as const,opacity:0.25,scale};
 return <AbsoluteFill style={{overflow:'hidden',backgroundColor:'#0a1412'}}>
  ...
  <AbsoluteFill style={{background:'linear-gradient(120deg,rgba(5,16,14,.65),rgba(8,18,17,.82))'}}/>
 </AbsoluteFill>;
};
