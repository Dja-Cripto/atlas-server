...
- As 104 cenas foram validadas. A renderização do MP4 parou ao tentar limpar o bundle temporário: `tempBundleDir is not defined`. A declaração foi movida para o escopo correto, preservando o erro original caso o render ainda falhe.
