...
**Atualizado em:** 25/09/2026, aproximadamente 14:25 (America/Bahia).
...
- V2 ativa: branch `codex/atlas-visual-v2`, commit `aeed061` implantado no VPS. Reversão documentada em `CHECKPOINTS.md`.
...
## Validação
- 100/100 testes locais aprovados; compilação TypeScript do renderizador e compilação TSX da fotografia de reserva aprovadas. VPS na revisão `aeed061`, contêiner saudável e painel respondendo HTTP 200.
...
- Gerar um novo vídeo curto de 30 segundos para medir qualidade visual e ocorrência de timeout. Se persistir falha do provedor, comparar modelos com um roteiro sintético antes de alterar o padrão.
