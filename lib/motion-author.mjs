...
export function withDocumentaryBookends(scenes){return scenes.map((scene,index)=>({...scene,editorialRole:index===0?'opening':index===scenes.length-1?'closing':'body'}));}
