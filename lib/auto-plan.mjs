...
export function validateDirection(slot,d,research){
 ...
 const result={...slot,kind,heading,caption:text(d.caption,130),query:text(d.query,100),location:text(d.location,80),countries:Array.isArray(d.countries)?d.countries.filter(x=>typeof x==='string'&&x.length<60).slice(0,5):[],routes:d.routes===true,layout:['full','split','overlay'].includes(d.layout)?d.layout:'full'};
